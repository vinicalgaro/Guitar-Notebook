...
class DefaultTextButton extends StatelessWidget {
  ...
  Color? _getBackgroundColor(BuildContext context) =>
      specialColor ?? Theme.of(context).inputDecorationTheme.fillColor;
  ...
  ButtonStyle _buildStyle(BuildContext context) {
    return TextButton.styleFrom(
        ...
        backgroundColor:
            hasBackgroundColor ? _getBackgroundColor(context) : null,
        foregroundColor: specialColor,
        side: showBorder
            ? BorderSide(
                color: specialColor ?? Theme.of(context).colorScheme.primary)
            : null,
        shape: showBorder
