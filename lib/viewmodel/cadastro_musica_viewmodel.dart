...
class CadastroMusicaViewModel extends ChangeNotifier {
  ...
  void atualizarNomeMusica(String nome) {
    _musicaRascunho = _musicaRascunho.copyWith(nome: nome);
  }

  void atualizarLinkYoutube(String link) {
    _musicaRascunho = _musicaRascunho.copyWith(linkYoutube: link);
  }
